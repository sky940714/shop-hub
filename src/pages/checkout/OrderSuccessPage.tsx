        ...
        {orderDetail && (
          <div className="order-info-card">
            <div className="info-row">
              ...
              <span className="info-value order-no">{orderDetail.orderNo}</span>
            </div>
            ...
            <div className="info-row">
              ...
              <span className="info-value">{getPaymentMethodText(orderDetail.paymentMethod)}</span>
            </div>

            <div className="info-row">
              <span className="info-label">配送方式</span>
              <span className="info-value">{getShippingMethodText(orderDetail.shippingMethod)}</span>
            </div>

            <div className="info-row">
              <span className="info-label">訂單時間</span>
              <span className="info-value">
                {new Date(orderDetail.createdAt).toLocaleString('zh-TW')}
              </span>
            </div>
          </div>
        )}
